...
export const pdfDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.pdf",
  sourceType: "pdf",
...
export const docxDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.docx",
  sourceType: "docx",
...
export const mdDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.md",
  sourceType: "md",
...
export const txtDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.txt",
  sourceType: "txt",
...
export const csvDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.csv",
  sourceType: "csv",
...
export const jsonDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.json",
  sourceType: "json",
...
export const yamlDocumentFixture: SourceDocument = {
  ...
  uri: "knowledge/fixtures/sample.yaml",
  sourceType: "yaml",
